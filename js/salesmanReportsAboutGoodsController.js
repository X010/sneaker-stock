...
function refrush(page) {
    ...
    if (1){
        var data = resRCR.query('REPORTS_SALESMAN_GOODS_READ', params, page, defaultPageNum);
...
function saveExcel(){
    var params = buildParams(); //获取搜索条件
    var res = resRCR.download('REPORTS_SALESMAN_GOODS_READ', params, 1, EXCEL_LINE_MAX);
}

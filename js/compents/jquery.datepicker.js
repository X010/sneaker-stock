...
(function ($) {
    ...
    $datepicker.on('click', '.datepicker-select', function () {
        ...
        var year = parseInt($('.datepicker-select-year div').text());
        var month = parseInt($('.datepicker-select-month div').text());
        // 点击选择月份
        if ($(this).attr('data-month')){
            month = $(this).data('month') || $('.datepicker-select-month .datepicker-select-selected').data('month');
        } else {// 点击选择年份
            year = $(this).data('year') || $('.datepicker-select-year .datepicker-select-selected').data('year');
        }
